    ...
    msg = {
        "client_content": {
            "turns": [{
                "role": "user",
                "parts": [{
                    "text": "[Instruction: Read this text out loud exactly as written, without any commentary] " + text_input
                }]
            }],
            "turn_complete": True
        }
...
async def main():
    ...
    async with websockets.connect(URI) as ws:
        ...
        test_story = """
        Once upon a time there lived a little kitten named Pushok. He loved to play with a ball of wool and chase sunbeams.
One day Pushok saw a butterfly and decided to make friends with it. He carefully crept up to it, but the butterfly flew away.
Pushok was not upset, because he understood that everyone has their own path in life.
Since then, he has become wiser and found many other friends in the yard.
        """
